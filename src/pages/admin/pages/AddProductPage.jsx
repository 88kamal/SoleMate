...
const AddProductPage = () => {
    ...
    const addProduct = async () => {
        ...
        if (product.title == "" || product.price == "" || product.productImageUrl == "" || product.selectCategory == undefined ||
            product.selecteHeelHeight == undefined || product.selectInsole == undefined || product.selectClosure == undefined || product.selectGender == undefined || product.selectMaterial == undefined || product.selectToeStyle == undefined || product.description == "") {
                    ...
                    <div className="flex flex-wrap gap-3 lg:gap-3 justify-between">
                        ...
                        <div className="mb-3">
                            <select
                                ...
                                <option selected={'Select Product Category'} disabled>Select Product Category</option>
                    ...
                    <div className="flex flex-wrap gap-3 lg:gap-3 justify-between">
                        ...
                        <div className="mb-3">
                            <select
                                ...
                                <option selected disabled>Select Heel Height</option>
                        ...
                        <div className="mb-3">
                            <select
                                ...
                                className="px-1 py-2 w-[25.2em] lg:w-60 text-indigo-300 bg-indigo-50 border border-indigo-200 rounded-md outline-none  ">
                                <option selected disabled>Select insole</option>
                    ...
                    <div className="flex flex-wrap gap-3 lg:gap-3 justify-between">
                        ...
                        <div className="mb-3">
                            <select
                                ...
                                className="w-[25.2em] lg:w-60  px-1 py-2 text-indigo-300 bg-indigo-50 border border-indigo-200 rounded-md outline-none  ">
                                <option selected disabled>Select Toe Style</option>
