            ...
            <div className="">
                <div className="flex lg:justify-around flex-wrap">
                    ...
                    <div className="mb-3">
                        ...
                        <select value={filterByHeelHeight} onChange={(e) => setFilterByHeelHeight(e.target.value)}
                            className="form-select w-80 lg:w-72 outline-none py-2 px-2 rounded-md mt-2 bg-indigo-100">
                ...
                <div className="flex lg:justify-around flex-wrap">
                    <div className="mb-3">
                        ...
                        <select value={filterByInSole} onChange={(e) => setFilterByInSole(e.target.value)}
                            className="form-select w-80 lg:w-72 outline-none py-2 px-2 rounded-md mt-2 bg-indigo-100">
                    ...
                    <div className="mb-3">
                        ...
                        <select value={filterByClosure} onChange={(e) => setFilterByClosure(e.target.value)}
                            className="form-select w-80 lg:w-72 outline-none py-2 px-2 rounded-md mt-2 bg-indigo-100">
                ...
                <div className="flex lg:justify-around flex-wrap">
                    <div className="mb-3">
                        ...
                        <select value={filterByGender} onChange={(e) => setFilterByGender(e.target.value)}
                            className="form-select w-80 lg:w-72 outline-none py-2 px-2 rounded-md mt-2 bg-indigo-100">
                    ...
                    <div className="mb-3">
                        ...
                        <select value={filterByMaterial} onChange={(e) => setFilterByMaterial(e.target.value)}
                            className="form-select w-80 lg:w-72 outline-none py-2 px-2 rounded-md mt-2 bg-indigo-100">
